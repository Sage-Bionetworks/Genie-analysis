...
```{r}
############# Table creation and initial data wrangling ##############
...
```{r}
# Final table of trial matches (latest, 1.0 genie release)
...
```{r}
# Final Graph, tumor frequencies per arm 
stacked_arm_tumor <- ggplot(df_with_x, aes(fill= forcats::fct_rev(summarised_parent_node), 
